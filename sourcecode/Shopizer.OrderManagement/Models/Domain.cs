...
public static class DtoMapper
{
    public static OrderDto Order(Order value, bool includeChildren = true) => new()
    {
        ...
        DatePurchased = value.DatePurchased.ToString("O"),
        OrderDateFinished = value.OrderDateFinished?.ToString("O"),
        PaymentType = value.PaymentType,
        PaymentModuleCode = value.PaymentModuleCode,
        ShippingModuleCode = value.ShippingModuleCode,
        CustomerAgreed = value.CustomerAgreed,
        ConfirmedAddress = value.ConfirmedAddress,
        Locale = value.Locale,
        BillingAddress = Address(value.BillingAddress),
        DeliveryAddress = Address(value.DeliveryAddress),
